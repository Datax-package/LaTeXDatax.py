...
def printvariables(filename,var_dict):
    """
    ...
    for name, value in var_dict.items():
        printvariable(name,value,filename)

# NOTE: 8/18 changing **variables to dictionary of variables for ease of use
def datax(var_dict, filename="data.tex"):
    """
    Print the given variables to a file to be read by the `datax` LaTeX
    package.
    """
    with open(filename, "w", encoding="utf-8") as f:
        printvariables(f,var_dict)
